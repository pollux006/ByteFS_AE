...
// const char *proc_dirname = "fs/BYTEFS";
// struct proc_dir_entry *bytefs_proc_root;

// /* ====================== Statistics ======================== */
// static int bytefs_seq_timing_show(struct seq_file *seq, void *v)
// {
// 	int i;

// 	bytefs_get_timing_stats();

// 	seq_puts(seq, "=========== BYTEFS kernel timing stats ===========\n");
...
// static int bytefs_seq_timing_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_timing_show, PDE_DATA(inode));
// }

// ssize_t bytefs_seq_clear_stats(struct file *filp, const char __user *buf,
...
// static const struct file_operations bytefs_seq_timing_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_timing_open,
// 	.read		= seq_read,
// 	.write		= bytefs_seq_clear_stats,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
// };

// static int bytefs_seq_IO_show(struct seq_file *seq, void *v)
// {
...
// 	seq_puts(seq, "============ BYTEFS allocation stats ============\n\n");
...
// 	bytefs_print_snapshot_lists(sb, seq);
// 	seq_puts(seq, "\n");

// 	return 0;
// }

// static int bytefs_seq_IO_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_IO_show, PDE_DATA(inode));
// }

// static const struct file_operations bytefs_seq_IO_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_IO_open,
// 	.read		= seq_read,
// 	.write		= bytefs_seq_clear_stats,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
...
// static int bytefs_seq_show_allocator(struct seq_file *seq, void *v)
// {
// 	struct super_block *sb = seq->private;
// 	struct bytefs_sb_info *sbi = BYTEFS_SB(sb);
// 	struct free_list *free_list;
...
// 	seq_puts(seq, "======== BYTEFS per-CPU allocator stats ========\n");
// 	for (i = 0; i < sbi->cpus; i++) {
// 		free_list = bytefs_get_free_list(sb, i);
...
// static int bytefs_seq_allocator_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_show_allocator,
// 				PDE_DATA(inode));
// }

// static const struct file_operations bytefs_seq_allocator_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_allocator_open,
// 	.read		= seq_read,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
// };
...
// /* ====================== Snapshot ======================== */
// static int bytefs_seq_create_snapshot_show(struct seq_file *seq, void *v)
// {
// 	seq_puts(seq, "Write to create a snapshot\n");
// 	return 0;
// }

// static int bytefs_seq_create_snapshot_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_create_snapshot_show,
// 				PDE_DATA(inode));
// }

// ssize_t bytefs_seq_create_snapshot(struct file *filp, const char __user *buf,
// 	size_t len, loff_t *ppos)
// {
// 	struct address_space *mapping = filp->f_mapping;
// 	struct inode *inode = mapping->host;
...
// 	bytefs_create_snapshot(sb);
// 	return len;
// }

// static const struct file_operations bytefs_seq_create_snapshot_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_create_snapshot_open,
// 	.read		= seq_read,
// 	.write		= bytefs_seq_create_snapshot,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
// };

// static int bytefs_seq_delete_snapshot_show(struct seq_file *seq, void *v)
// {
// 	seq_puts(seq, "Echo index to delete a snapshot\n");
// 	return 0;
// }

// static int bytefs_seq_delete_snapshot_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_delete_snapshot_show,
// 				PDE_DATA(inode));
// }

// ssize_t bytefs_seq_delete_snapshot(struct file *filp, const char __user *buf,
// 	size_t len, loff_t *ppos)
// {
// 	struct address_space *mapping = filp->f_mapping;
// 	struct inode *inode = mapping->host;
...
// 	bytefs_delete_snapshot(sb, epoch_id);

// 	return len;
// }

// static const struct file_operations bytefs_seq_delete_snapshot_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_delete_snapshot_open,
// 	.read		= seq_read,
// 	.write		= bytefs_seq_delete_snapshot,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
// };

// static int bytefs_seq_show_snapshots(struct seq_file *seq, void *v)
// {
// 	struct super_block *sb = seq->private;

// 	bytefs_print_snapshots(sb, seq);
// 	return 0;
// }

// static int bytefs_seq_show_snapshots_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_show_snapshots,
// 				PDE_DATA(inode));
// }

// static const struct file_operations bytefs_seq_show_snapshots_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_show_snapshots_open,
// 	.read		= seq_read,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
// };
...
// /* ====================== Performance ======================== */
// static int bytefs_seq_test_perf_show(struct seq_file *seq, void *v)
// {
// 	seq_printf(seq, "Echo function:poolmb:size:disks to test function performance working on size of data.\n"
// 			"    example: echo 1:128:4096:8 > /proc/fs/BYTEFS/pmem0/test_perf\n"
// 			"The disks value only matters for raid functions.\n"
// 			"Set function to 0 to test all functions.\n");
// 	return 0;
// }

// static int bytefs_seq_test_perf_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_test_perf_show, PDE_DATA(inode));
// }

// ssize_t bytefs_seq_test_perf(struct file *filp, const char __user *buf,
// 	size_t len, loff_t *ppos)
// {
// 	struct address_space *mapping = filp->f_mapping;
// 	struct inode *inode = mapping->host;
...
// 		bytefs_test_perf(sb, func_id, poolmb, size, disks);
// 	else
// 		bytefs_warn("Couldn't parse test_perf request: %s", buf);

// 	return len;
// }

// static const struct file_operations bytefs_seq_test_perf_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_test_perf_open,
// 	.read		= seq_read,
// 	.write		= bytefs_seq_test_perf,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
// };
...
// static int bytefs_seq_gc_show(struct seq_file *seq, void *v)
// {
// 	seq_printf(seq, "Echo inode number to trigger garbage collection\n"
// 		   "    example: echo 34 > /proc/fs/BYTEFS/pmem0/gc\n");
// 	return 0;
// }

// static int bytefs_seq_gc_open(struct inode *inode, struct file *file)
// {
// 	return single_open(file, bytefs_seq_gc_show, PDE_DATA(inode));
// }

// ssize_t bytefs_seq_gc(struct file *filp, const char __user *buf,
// 	size_t len, loff_t *ppos)
// {
...
// 	struct bytefs_inode *target_pi;
// 	struct bytefs_inode_info *target_sih;
...
// 	bytefs_info("%s: target_inode_number=%llu.", __func__,
// 		  target_inode_number);

// 	/* FIXME: inode_number must exist */
// 	if (target_inode_number < BYTEFS_NORMAL_INODE_START &&
// 			target_inode_number != BYTEFS_ROOT_INO) {
// 		bytefs_info("%s: invalid inode %llu.", __func__,
// 			  target_inode_number);
// 		retval = -ENOENT;
// 		goto out;
// 	}

// 	target_inode = bytefs_iget(sb, target_inode_number);
// 	if (target_inode == NULL) {
// 		bytefs_info("%s: inode %llu does not exist.", __func__,
// 			  target_inode_number);
// 		retval = -ENOENT;
// 		goto out;
// 	}

// 	target_pi = bytefs_get_inode(sb, target_inode);
// 	if (target_pi == NULL) {
// 		bytefs_info("%s: couldn't get bytefs inode %llu.", __func__,
// 			  target_inode_number);
// 		retval = -ENOENT;
// 		goto out;
// 	}

// 	target_sih = BYTEFS_I(target_inode);

// 	bytefs_info("%s: got inode %llu @ 0x%p; pi=0x%p\n", __func__,
// 		  target_inode_number, target_inode, target_pi);

// 	bytefs_inode_log_fast_gc(sb, target_pi, &target_sih->header,
// 			       0, 0, 0, 0, 1);
// 	iput(target_inode);
...
// static const struct file_operations bytefs_seq_gc_fops = {
// 	.owner		= THIS_MODULE,
// 	.open		= bytefs_seq_gc_open,
// 	.read		= seq_read,
// 	.write		= bytefs_seq_gc,
// 	.llseek		= seq_lseek,
// 	.release	= single_release,
