...
#define BYTEFS_LOG_REGION_SIZE_IN_PAGE      (65536UL)
#define BYTEFS_LOG_REGION_SIZE              (BYTEFS_LOG_REGION_SIZE_IN_PAGE * PG_SIZE)
#define BYTEFS_LOG_FLUSH_HI_THRESHOLD       (BYTEFS_LOG_REGION_SIZE * 75 / 100)
...
#define BYTEFS_MT_LOAD_FACTOR_INV           (10)
#define BYTEFS_MT_SIZE                      (BYTEFS_LOG_REGION_MAX_ENTRY_NUM * BYTEFS_MT_LOAD_FACTOR_INV)
...
struct ssd {
    ...
    void *bytefs_log_region_start;
    void *bytefs_log_region_end;
    struct bytefs_log_metadata *log_wp;
    struct bytefs_log_metadata *log_rp;
    volatile uint64_t log_size;
    struct indirection_mte *indirection_mt;
    struct coalescing_mte *coalescing_mt;
    int imt_size;
    int cmt_size;
